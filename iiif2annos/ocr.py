...
def buildAnno(canvas, ident, x, y, width, height, content):
    if "id" in canvas:
        return {
            ...
            "body": {"type": "TextualBody", "format": "text/plain", "value": content},
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog="ocr.py",
        description=(
            "Read a manifest, OCR all the pages then adds the results as annotation"
            " lists"
        ),
    )
    ...
    parser.add_argument(
        "--base-output-uri",
        dest="outputURI",
        default="http://localhost/annos",
        help="Output URI for annotations",
    )
    parser.add_argument(
        "--lang",
        dest="lang",
        default=None,
        help=(
            "Language to pass to the OCR engine see:"
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Include OCR confidence value in text of the annotation? ",
    )
